...
#define SEND_DATA_SIZE    16         //The length of data sent by ROS to the lower machine //ROS向下位机发送的数据的长度
#define PI 				  3.1415926f //PI //圆周率
#define FRAME_HEADER_ARM      0XAA//机械臂帧头
#define FRAME_TAIL_ARM  0XBB //机械臂命令帧尾
...
class turn_on_robot
{
	...
	private:
		...
		ros::Subscriber Cmd_Vel_Sub,joint_state_Sub; //Initialize the topic subscriber //初始化话题订阅者
